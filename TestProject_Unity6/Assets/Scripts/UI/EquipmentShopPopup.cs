...
public class EquipmentShopPopup : UIPopup
{
    ...
    private void Start()
    {
        ...
        SetPopup(new List<Equipment>() {
            ...
            new Equipment(2, 0, Equipment.Part.Weapon),
            new Equipment(3, 0, Equipment.Part.Weapon),
            new Equipment(1, 0, Equipment.Part.Necklace),
            new Equipment(2, 0, Equipment.Part.Necklace),
            new Equipment(3, 0, Equipment.Part.Necklace),
            new Equipment(1, 0, Equipment.Part.Gloves),
            new Equipment(2, 0, Equipment.Part.Gloves),
            new Equipment(3, 0, Equipment.Part.Gloves),
            new Equipment(1, 0, Equipment.Part.Hat),
            new Equipment(2, 0, Equipment.Part.Hat),
            new Equipment(3, 0, Equipment.Part.Hat),
            new Equipment(1, 0, Equipment.Part.Armor),
            new Equipment(2, 0, Equipment.Part.Armor),
            new Equipment(3, 0, Equipment.Part.Armor),
            new Equipment(1, 0, Equipment.Part.Shoes),
            new Equipment(2, 0, Equipment.Part.Shoes),
            new Equipment(3, 0, Equipment.Part.Shoes),
        });
    }
